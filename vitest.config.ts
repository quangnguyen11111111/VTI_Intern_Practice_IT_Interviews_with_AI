  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/services/InterviewWorkflowService.ts',
        'src/services/InterviewOperationProcessor.ts',
        'src/services/ai/output-validation.ts',
        'src/services/ai/provider-errors.ts',
        'src/infrastructure/jobs/OutboxDispatcher.ts',
        'src/utils/token.ts',
