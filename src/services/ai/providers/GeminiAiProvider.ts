...
3. **Realistic Interview Tone**: Write questions the way a real interviewer would ask them — conversational but precise. For scenario questions, provide a brief realistic context.
...
2. **Theory vs Practice Mix**: At least 2 questions must be theoretical and at least 2 must be practical/scenario-based.
3. **Realistic Interview Tone**: Write questions the way a real interviewer would ask them.
4. **No Repetition**: Do NOT ask generic textbook questions. Ask questions that require applied understanding.
5. **Bilingual Output**: Provide each question in both English (content.en) and Vietnamese (content.vi).
