    ...
    <div className="w-full flex-grow animate-fade-in-up">
      <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12">
        <div className="mb-5 flex items-center justify-between">
          <Link
            to="/"
            className="inline-flex rounded-lg px-2 py-1 font-semibold text-slate-600 hover:text-indigo-700 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-indigo-100"
          >
            ← Về trang chủ
          </Link>
          ...
          <header className="flex flex-col items-center gap-4 bg-gradient-to-r from-indigo-50 to-purple-50 px-6 py-8 text-center sm:flex-row sm:text-left">
            ...
            <div>
              ...
              <p className="mt-1 text-slate-600">
                Thông tin dùng để cá nhân hóa trải nghiệm phỏng vấn.
              </p>
            </div>
          </header>
          ...
          <div className="p-6 sm:p-8">
            {loading && (
              <div
                role="status"
                aria-live="polite"
                className="py-12 text-center font-semibold text-slate-600"
              >
                Đang tải hồ sơ…
              </div>
            )}
            ...
            {!loading && loadError && (
              <div
                role="alert"
                className="rounded-2xl border border-red-200 bg-red-50 p-5 text-center text-red-800"
              >
              ...
              >
                {saved && (
                  <div
                    role="status"
                    aria-live="polite"
                    className="rounded-xl border border-emerald-200 bg-emerald-50 p-3 font-semibold text-emerald-800"
                  >
                ...
                {saveError && (
                  <div
                    role="alert"
                    className="rounded-xl border border-red-200 bg-red-50 p-3 font-semibold text-red-800"
                  >
                    {saveError.message}
                  </div>
                )}
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      className="mt-1.5 w-full rounded-xl border border-slate-200 bg-slate-100 px-4 py-3 text-slate-600"
                    />
                  </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className={inputClass(Boolean(errors.currentLevel))}
                  >
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-400">
                    Tối đa 500 ký tự. Hiển thị trong hồ sơ phỏng vấn của bạn.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <label className="flex cursor-pointer items-start gap-3">
                    <input
                      ...
                      className="mt-1 h-4 w-4 rounded border-slate-300 text-indigo-600 focus:ring-4 focus:ring-indigo-100"
                    />
                    ...
                    <span>
                      ...
                      <span className="mt-1 block text-sm text-slate-500">
                        Chỉ bật khi bạn muốn tên hiển thị xuất hiện trên
                        leaderboard. Mặc định là tắt.
                      </span>
                    </span>
                  </label>

                  {errors.leaderboardOptIn && (
                    <p role="alert" className="mt-2 text-sm text-red-700">
                      {errors.leaderboardOptIn.message}
                    </p>
                  )}
                </div>
